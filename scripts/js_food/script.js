$(function() {
    ...
    alert("Choose cat with correct food");
...
game = {
    settings: function (_timeOut, _timeOutStep) {
        ...
        food = [];
        food[0] = 'images/images_food/food/burger.png';
        food[1] = "images/images_food/food/meat.png";
        food[2] = "images/images_food/food/pizza.png";
        food[3] = "images/images_food/food/cake.png";
        food[4] = "images/images_food/food/pizza2.png";
        food[5] = "images/images_food/food/chicken-meat.png";
    ...
    lostLife: function () {
        ...
        if (countLife == 0) {
            ...
            saveScore();
            numberImg = undefined;
            playPause.attr({"src":"images/images_food/imgs/reload.png"}).attr('onclick', 'location.reload();');
            image_food.hide();
            $('#game-over').show();
            sad_melody.play();
        }
    ...
    changeStatusGame: function () {
        ...
        if (play) {
            playPause.attr({"src":"images/images_food/imgs/play.png"});
            game.pause();
            play = false;
        }
        //user clicks the play
        else {
            playPause.attr({"src":"images/images_food/imgs/pause.png"});
            text_game.show();
            image_food.hide();
            play = true;
            show = false;
    ...
    pause: function () {
        game.stop();
        image_food.attr({"src" : "images/images_food/imgs/levelup.png"}).show();
    },
    ...
    timerForGame: function(){
        ...
        setTimeout(function () {
            text_game.hide();
            playPause.show().attr({"src":"images/images_food/imgs/pause.png"});
            sec.text(3);
        },timeOut);
    }
};
